...
namespace ExampleFilters
{
						...
						, IAMBufferNegotiation
    {
        ...
        private DateTime _FPSStart = DateTime.Now;
        private int _FPSCount = 1;

        private DateTime _FPS2Start = DateTime.Now;        
        private int _FPS2Count = 0;
    ...
    public class VirtualCamFilter : BaseSourceFilter, IAMFilterMiscFlags
    {
        ...
        private const int c_iDefaultWidth = 1280;
        private const int c_iDefaultHeight = 720;
        private const int c_nDefaultBitCount = 32;
        private const int c_iDefaultFPS = 25;
        ...
        private const int c_nMaxFPS = 100;
        ...
        public override int Pause()
        {
            ...
            {
                //IntPtr window = FindWindow(null, "GameMaker: Studio");
                //Graphics graphic = Graphics.FromHwnd(window);
                //m_hScreenDC = graphic.GetHdc();                
